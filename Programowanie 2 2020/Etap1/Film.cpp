...
using namespace std;
Film Karamba;
// Funkcja realizujaca wybor gatunku filmu
...
// Funkcja przez któr¹ wybieramy kwotê z bud¿etu studia, na produkcje filmow¹
...
// Funkcja która przypisuje now¹ wartoœæ bud¿etowi
void Film::Nowy_budzet(double i) {
	bud = i;
}
// Funkcja ustalajaca czas trwania filmu
double Film::M_time() {
...
//Funckja prosz¹ca u¿ytkownika o podanie nazwy filmu
string Film::set_tyt() {
	//char s[M];
