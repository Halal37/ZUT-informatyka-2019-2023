...
#define stala 29
void Monatzysta::set_rep(int s) {
	rep = s;
}
void Monatzysta::set_gat(int s) {
	gat = s;
}
void Monatzysta::set_pen(int s) {
	pen = s;
}
void Monatzysta::set_roz(int s) {
	roz = s;
}
void Monatzysta::set_prof(int s) {
	prof = s;
}
void Monatzysta::set_imie(string s) { imie = s; }
void Monatzysta::set_nazwisko(string s) { nazwisko = s; }
//srand(time(NULL));
void Monatzysta::stworz(int z)
{
