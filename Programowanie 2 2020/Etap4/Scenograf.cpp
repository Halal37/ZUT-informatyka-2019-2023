#include "Scenograf.h"
#define stala 29
void Scenograf::set_rep(int s) {
	rep = s;
}
void Scenograf::set_gat(int s) {
	gat = s;
}
void Scenograf::set_pen(int s) {
	pen = s;
}
void Scenograf::set_roz(int s) {
	roz = s;
}
void Scenograf::set_prof(int s) {
	prof = s;
}
void Scenograf::set_imie(string s) { imie = s; }
void Scenograf::set_nazwisko(string s) { nazwisko = s; }
//srand(time(NULL));
void Scenograf::stworz(int z)
{
